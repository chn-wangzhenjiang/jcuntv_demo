...
public class Table implements java.io.Serializable,Cloneable {
	...
	public String getTreeNameColumn() {
		return treeNameColumn;
	}

	public void setTreeNameColumn(String treeNameColumn) {
		this.treeNameColumn = treeNameColumn;
	}

	public String getTreeParentColumn() {
		return treeParentColumn;
	}

	public void setTreeParentColumn(String treeParentColumn) {
