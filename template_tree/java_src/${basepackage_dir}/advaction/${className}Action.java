...
public class ${className}Action extends BaseStruts2Action implements Preparable,ModelDriven{
	...
	protected static final String ERROR_JSP= "${jspFileBasePath}/error.jsp";	
	protected static final String RESULT_ACTION = "${jspFileBasePath}/editresult.jsp";	
